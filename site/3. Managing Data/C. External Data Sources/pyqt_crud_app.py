#!/usr/bin/env python3
"""
PyQt6 REST API CRUD Application
A simple GUI application demonstrating CRUD operations with a REST API using threading.
"""
...
class PostCrudApp(QMainWindow):
    ...
    def setup_window(self):
        ...
        self.setWindowTitle("REST API CRUD Demo - Post Manager")
    ...
    def add_title_section(self, main_layout):
        ...
        title_label = QLabel("Post Manager - REST API CRUD Operations")
        title_font = QFont()
    ...
    def add_input_section(self, main_layout):
        """Add the input fields section"""
        input_group = QGroupBox("Post Data")
        input_layout = QVBoxLayout(input_group)

        # Post ID (for read, update, delete)
        id_layout = QHBoxLayout()
        id_layout.addWidget(QLabel("Post ID:"))
        self.post_id_input = QLineEdit()
        self.post_id_input.setPlaceholderText("Enter post ID (for read/update/delete)")
        id_layout.addWidget(self.post_id_input)
        ...
        self.body_input.setPlaceholderText("Enter post content")
        ...
        self.user_id_input.setPlaceholderText("Enter user ID (default: 1)")
    ...
    def add_buttons_section(self, main_layout):
        """Add the operation buttons section"""
        buttons_group = QGroupBox("Operations")
        buttons_layout = QHBoxLayout(buttons_group)

        self.create_btn = QPushButton("Create Post")
        self.read_btn = QPushButton("Read Post")
        self.update_btn = QPushButton("Update Post")
        self.delete_btn = QPushButton("Delete Post")
        self.read_all_btn = QPushButton("Load All Posts")
        ...
        buttons_layout.addWidget(self.read_all_btn)
...
def main():
    ...
    app.setApplicationName("REST API CRUD Demo")
